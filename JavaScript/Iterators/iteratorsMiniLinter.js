...
/*
In the code editor, there is a string called story. We want to gather some information about the individual words and sentences in the string.
...
for (let storyWordsIndex = 0; storyWordsIndex < storyWords.length; storyWordsIndex++) {
  if (storyWords[storyWordsIndex] === 'really') {
    reallyCount++;
  } else if (storyWords[storyWordsIndex] === 'very') {
    veryCount++;
  }	else if (storyWords[storyWordsIndex] === 'basically') {
    basicallyCount++;
}
}
